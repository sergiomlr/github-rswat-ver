...
=======
>>>>>>> c2cd512df9d9a343a72fa9a4c8181eb0265f2bda
```
...
#"C:/Veracruz/SWAT/github-rswat-ver/swat_models/sim_swat_t"
>>>>>>> c2cd512df9d9a343a72fa9a4c8181eb0265f2bda
...
=======
               #"BLAI{1,2,40,6,12,94}.plant.dat|change = relchg",
               "CANMX.hru|change = relchg"
               )
...
=======
  minimum = c(-0.35, -0.8, -0.3, -0.25, 0, 0, 0.02, 0, 0, 0, 5, 0, 0, 0, -0.2, -0.3, 0,-0.3),
  maximum = c(0.35, 0.8, 0.3, 0.25, 1, 650, 0.2, 2000, 1, 500, 130, 0.3, 1, 1, 0.2, 0.3, 10,0.3),
>>>>>>> c2cd512df9d9a343a72fa9a4c8181eb0265f2bda
  names = par_names) %>%
  as_tibble()
...
=======
q_fast_l <- run_swat2012(project_path = path_2012,
>>>>>>> c2cd512df9d9a343a72fa9a4c8181eb0265f2bda
            output = list(q_out = define_output(file = "rch",
                                  variable = "FLOW_OUT",
                                  unit = c(6,15))), # gavilanes = 15, pixquiac = 6
...
Reducing the universe of plausible non unique parameter sets with multiple contraints
