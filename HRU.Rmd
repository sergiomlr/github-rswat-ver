...
# Plot MF
ggplot(HRU$MF, aes(p,value)) + geom_line(aes(colour = series)) + 
  geom_line(data=HRU$obs, aes(P_PF, Q_PF))+
  scale_y_continuous(trans="log2")

# Plot IF
ggplot(HRU$IF, aes(p,value)) + geom_line(aes(colour = series)) + 
...
#Compute mean quantile discharge

print(tapply(HRU$MF$value[HRU$MF$p > 0.945 & HRU$MF$p < 0.955], HRU$MF$series[HRU$MF$p > 0.945 & HRU$MF$p < 0.955], mean))
